...
-- Listage des données de la table bmflash.about_us : ~0 rows (environ)
...
-- Listage des données de la table bmflash.admins : ~0 rows (environ)
...
-- Listage des données de la table bmflash.announcement_modals : ~0 rows (environ)
...
-- Listage des données de la table bmflash.bank_payments : ~0 rows (environ)
...
INSERT INTO `bank_payments` (`id`, `status`, `account_info`, `cash_on_delivery_status`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Bank Name: Your bank name\r\nAccount Number:  Your bank account number\r\nRouting Number: Your bank routing number\r\nBranch: Your bank branch name', 1, NULL, '2022-07-30 04:48:29');
...
INSERT INTO `categories` (`id`, `name`, `slug`, `icon`, `status`, `image`, `created_at`, `updated_at`) VALUES
	(1, 'Electronics', 'electronics', 'fas fa-anchor', 1, 'uploads/custom-images/electronics-2022-11-19-02-48-28-5548.png', '2022-09-20 06:16:25', '2022-11-22 05:08:36'),
	(2, 'Game', 'game', 'fas fa-gamepad', 1, 'uploads/custom-images/game-2022-11-19-02-48-48-6382.png', '2022-09-20 06:16:50', '2022-11-22 19:09:39'),
	(3, 'Mobile', 'mobile', 'fas fa-mobile-alt', 1, 'uploads/custom-images/mobile-2022-11-19-02-49-20-2538.png', '2022-09-20 06:17:43', '2022-11-19 20:49:20'),
	(4, 'Lifestyle', 'lifestyle', 'fas fa-home', 1, 'uploads/custom-images/lifestyle-2022-11-19-02-49-38-3139.png', '2022-09-20 06:24:47', '2022-11-19 20:49:38'),
	(5, 'Babies & Toys', 'babies-toys', 'fas fa-basketball-ball', 1, 'uploads/custom-images/babies-toys-2022-11-19-02-50-00-3811.png', '2022-09-20 06:26:13', '2022-11-21 00:14:20'),
	(6, 'Bike', 'bike', 'fas fa-bicycle', 1, 'uploads/custom-images/bike-2022-11-19-02-50-18-4648.png', '2022-09-20 06:28:22', '2022-11-19 20:50:18'),
	(7, 'Men\'s Fasion', 'mens-fasion', 'fas fa-street-view', 1, 'uploads/custom-images/mens-fasion-2022-11-19-02-50-39-5203.png', '2022-09-20 06:35:28', '2022-11-19 20:50:39'),
	(8, 'Woman Fashion', 'woman-fashion', 'fab fa-android', 1, 'uploads/custom-images/womans-fasion-2022-11-19-02-52-58-2850.png', '2022-09-20 06:38:38', '2022-11-21 11:45:01'),
	(9, 'Talevision', 'talevision', 'fas fa-adjust', 1, NULL, '2022-09-20 07:04:03', '2022-11-19 20:52:40'),
	(10, 'Accessories', 'accessories', 'fas fa-cogs', 1, NULL, '2022-09-20 07:05:41', '2022-09-20 10:56:55'),
	(11, 'John Doe', 'john-doe', 'fas fa-adjust', 1, 'uploads/custom-images/john-doe-2022-11-17-12-00-23-1751.jpg', '2022-11-17 06:54:49', '2022-11-17 07:00:23');
...
-- Listage des données de la table bmflash.cities : ~10 rows (environ)
/*!40000 ALTER TABLE `cities` DISABLE KEYS */;
INSERT INTO `cities` (`id`, `country_state_id`, `name`, `slug`, `status`, `created_at`, `updated_at`) VALUES
	(1, 2, 'Florida City', 'florida-city', 1, '2022-01-30 10:29:19', '2022-02-06 05:18:33'),
	(2, 1, 'Los Angeles', 'los-angeles', 1, '2022-01-30 10:29:29', '2022-02-06 05:20:30'),
	(4, 2, 'Tallahassee', 'tallahassee', 1, '2022-02-06 05:18:49', '2022-02-06 05:18:49'),
	(5, 2, 'Weston', 'weston', 1, '2022-02-06 05:19:56', '2022-02-06 05:19:56'),
	(6, 1, 'San Jose', 'san-jose', 1, '2022-02-06 05:21:08', '2022-02-06 05:21:08'),
	(7, 1, 'San Diego', 'san-diego', 1, '2022-02-06 05:21:26', '2022-02-06 05:21:26'),
	(8, 4, 'Gandhinagar', 'gandhinagar', 1, '2022-02-06 05:22:21', '2022-02-06 05:22:21'),
	(9, 5, 'Chandigarh', 'chandigarh', 1, '2022-02-06 05:22:44', '2022-02-06 05:22:44'),
	(10, 7, 'London', 'london', 1, '2022-02-06 05:23:12', '2022-02-06 05:23:12'),
	(11, 7, 'Liverpool', 'liverpool', 1, '2022-02-06 05:23:29', '2022-07-31 03:52:47');
...
-- Listage des données de la table bmflash.cookie_consents : ~0 rows (environ)
...
-- Listage des données de la table bmflash.countries : ~5 rows (environ)
/*!40000 ALTER TABLE `countries` DISABLE KEYS */;
INSERT INTO `countries` (`id`, `name`, `slug`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'United State', 'united-state', 1, '2022-01-30 10:28:28', '2022-02-06 05:11:42'),
	(2, 'India', 'india', 1, '2022-01-30 10:28:39', '2022-01-30 10:28:39'),
	(4, 'United Kindom', 'united-kindom', 1, '2022-02-06 05:11:51', '2022-02-06 05:11:51'),
	(5, 'Australia', 'australia', 1, '2022-02-06 05:12:36', '2022-02-06 05:12:36'),
	(10, 'Bangladesh', 'bangladesh', 1, '2022-09-22 06:46:54', '2022-09-22 06:46:54');
...
-- Listage des données de la table bmflash.country_states : ~9 rows (environ)
...
INSERT INTO `country_states` (`id`, `country_id`, `name`, `slug`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 'California', 'california', 1, '2022-01-30 10:29:00', '2022-02-06 05:14:28'),
	(2, 1, 'Florida', 'florida', 1, '2022-01-30 10:29:07', '2022-02-06 05:14:42'),
	(3, 1, 'Alaska', 'alaska', 1, '2022-02-05 08:49:14', '2022-02-06 05:15:09'),
	(4, 2, 'Gujarat', 'gujarat', 1, '2022-02-06 05:16:27', '2022-02-06 05:16:27'),
	(5, 2, 'Punjab', 'punjab', 1, '2022-02-06 05:16:39', '2022-02-06 05:16:39'),
	(6, 2, 'Rajasthan', 'rajasthan', 1, '2022-02-06 05:16:48', '2022-02-06 05:16:48'),
	(7, 4, 'England', 'england', 1, '2022-02-06 05:17:35', '2022-02-06 05:17:35'),
	(8, 4, 'Scotland', 'scotland', 1, '2022-02-06 05:17:44', '2022-02-06 05:17:44'),
	(9, 4, 'Wales', 'wales', 1, '2022-02-06 05:17:53', '2022-02-06 05:17:53');
...
-- Listage des données de la table bmflash.coupons : ~0 rows (environ)
...
-- Listage des données de la table bmflash.custom_pages : ~0 rows (environ)
...
-- Listage des données de la table bmflash.email_configurations : ~0 rows (environ)
...
-- Listage des données de la table bmflash.facebook_comments : ~0 rows (environ)
...
-- Listage des données de la table bmflash.facebook_pixels : ~0 rows (environ)
...
-- Listage des données de la table bmflash.flutterwaves : ~0 rows (environ)
...
INSERT INTO `flutterwaves` (`id`, `public_key`, `secret_key`, `currency_rate`, `country_code`, `currency_code`, `title`, `logo`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'FLWPUBK_TEST-5760e3ff9888aa1ab5e5cd1ec3f99cb1-X', 'FLWSECK_TEST-81cb5da016d0a51f7329d4a8057e766d-X', 417.35, 'NG', 'NGN', 'Ecommerce', 'uploads/website-images/flutterwave-2021-12-30-03-44-30-8813.jpg', 1, NULL, '2022-02-07 03:31:07');
...
-- Listage des données de la table bmflash.google_analytics : ~0 rows (environ)
...
-- Listage des données de la table bmflash.google_recaptchas : ~0 rows (environ)
...
INSERT INTO `google_recaptchas` (`id`, `site_key`, `secret_key`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'test', 'test', 1, NULL, '2022-06-11 12:05:35');
...
-- Listage des données de la table bmflash.instamojo_payments : ~0 rows (environ)
...
INSERT INTO `instamojo_payments` (`id`, `api_key`, `auth_token`, `currency_rate`, `account_mode`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'test_5f4a2c9a58ef216f8a1a688910f', 'test_994252ada69ce7b3d282b9941c2', '74.66', 'Sandbox', 1, NULL, '2022-02-07 03:32:41');
...
-- Listage des données de la table bmflash.maintainance_texts : ~0 rows (environ)
...
-- Listage des données de la table bmflash.paymongo_payments : ~0 rows (environ)
...
-- Listage des données de la table bmflash.paypal_payments : ~0 rows (environ)
...
-- Listage des données de la table bmflash.paystack_and_mollies : ~0 rows (environ)
...
INSERT INTO `paystack_and_mollies` (`id`, `mollie_key`, `mollie_status`, `mollie_currency_rate`, `paystack_public_key`, `paystack_secret_key`, `paystack_currency_rate`, `paystack_status`, `mollie_country_code`, `mollie_currency_code`, `paystack_country_code`, `paystack_currency_code`, `created_at`, `updated_at`) VALUES
	(1, 'test_p9qgUn7Sg22xF3Q8D9heBSVEzrzM5Q', 1, 1.27, 'pk_test_057dfe5dee14eaf9c3b4573df1e3760c02c06e38', 'sk_test_77cb93329abbdc18104466e694c9f720a7d69c97', 417.35, 1, 'CA', 'CAD', 'NG', 'NGN', NULL, '2022-08-25 08:10:34');
...
-- Listage des données de la table bmflash.products : ~35 rows (environ)
...
-- Listage des données de la table bmflash.product_specification_keys : ~0 rows (environ)
...
-- Listage des données de la table bmflash.product_variants : ~0 rows (environ)
...
-- Listage des données de la table bmflash.pusher_credentails : ~0 rows (environ)
...
-- Listage des données de la table bmflash.razorpay_payments : ~0 rows (environ)
...
INSERT INTO `razorpay_payments` (`id`, `status`, `name`, `currency_rate`, `country_code`, `currency_code`, `description`, `image`, `color`, `key`, `secret_key`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Ecommerce', 74.66, 'IN', 'INR', 'This is description', 'uploads/website-images/razorpay-2021-12-14-06-35-49-6602.png', '#2d15e5', 'rzp_test_K7CipNQYyyMPiS', 'zSBmNMorJrirOrnDrbOd1ALO', NULL, '2022-11-18 03:24:09');
...
-- Listage des données de la table bmflash.shopping_carts : ~5 rows (environ)
...
-- Listage des données de la table bmflash.shop_pages : ~0 rows (environ)
...
-- Listage des données de la table bmflash.social_login_information : ~0 rows (environ)
...
-- Listage des données de la table bmflash.sslcommerz_payments : ~0 rows (environ)
...
INSERT INTO `sslcommerz_payments` (`id`, `store_id`, `store_password`, `mode`, `currency_rate`, `country_code`, `currency_code`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'wsus628f03bb09670', 'wsus628f03bb09670@ssl', 'sandbox', '80', 'BD', 'BDT', 1, NULL, '2022-11-03 05:55:07');
...
-- Listage des données de la table bmflash.stripe_payments : ~0 rows (environ)
...
INSERT INTO `stripe_payments` (`id`, `status`, `stripe_key`, `stripe_secret`, `created_at`, `updated_at`, `country_code`, `currency_code`, `currency_rate`) VALUES
	(1, 1, 'pk_test_51JU61aF56Pb8BOOX5ucAe5DlDwAkCZyffqlKMDUWsAwhKbdtuY71VvIzr0NgFKjq4sOVVaaeeyVXXnNWwu5dKgeq00kMzCBUm5', 'sk_test_51JU61aF56Pb8BOOXlz7jGkzJsCkozuAoRlFJskYGsgunfaHLmcvKLubYRQLCQOuyYHq0mvjoBFLzV7d8F6q8f6Hv00CGwULEEV', NULL, '2022-11-18 03:24:05', 'US', 'USD', 1);
...
-- Listage des données de la table bmflash.tawk_chats : ~0 rows (environ)
...
-- Listage des données de la table bmflash.terms_and_conditions : ~0 rows (environ)
...
-- Listage des données de la table bmflash.three_column_categories : ~0 rows (environ)
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `forget_password_token`, `status`, `provider_id`, `provider`, `provider_avatar`, `image`, `phone`, `country_id`, `state_id`, `city_id`, `zip_code`, `address`, `is_vendor`, `verify_token`, `email_verified`, `agree_policy`, `created_at`, `updated_at`) VALUES
	(1, 'Abdur1 Rohman1', 'facik91345@pahed.com', NULL, '$2y$10$1fb1W./8xpgma9gJo/nGIu8eGxqoULkt8cKsCBLBcZwQJ/yS81/sW', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '973589', 0, 1, '2022-09-20 11:04:42', '2022-09-20 11:04:42'),
	(2, 'John Do', 'meyaj42636@pahed.com', NULL, '$2y$10$PCusAOjlo72nk4dfE9mJl.AQ/i9BBjczfwYqhRxtudDGQzoV4U2Ki', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '846418', 0, 1, '2022-09-21 06:25:34', '2022-09-21 06:25:34'),
	(3, 'John Do', 'piway67338@geekjun.com', NULL, '$2y$10$MWP/Jt4d1Sz0U6NrOPZcSutWhIuAb3eeV4Erw82YP7ja32Qjl8LQC', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '191269', 0, 1, '2022-09-21 06:26:32', '2022-09-21 06:26:32'),
	(4, 'Autumn Decker Dean', 'jipof28122@orlydns.com', NULL, '$2y$10$B3aOUPcMKFQUKR9af/taSei07iAEaiT2TaaWaofuM4cMuspsIffH.', 'Ou5C4kwC0iMZ7K2nAP7m2mZulHnXvIhz5j3VAaWNxboVpCbwFcUVPpPP8DXX', NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-09-21 06:33:41', '2022-09-21 06:39:16'),
	(5, 's s', 'marohman74@gmail.com', NULL, '$2y$10$fLfrcsXAEO4Ppl.RzHEj2ObbdSBKKgy8XC3kPDIjE/Fqp.yRnCqea', NULL, NULL, 1, NULL, NULL, NULL, 'uploads/custom-images/s-s-2022-09-22-10-19-00-8064.jpg', '+881682825123', 0, 0, 0, NULL, 'qww', 0, NULL, 1, 1, '2022-09-21 06:40:21', '2022-11-21 15:18:05'),
	(6, 'nayeem', 'mrnayeem75@gmail.com', NULL, '$2y$10$97EjXmtnALzk8asIK7c92exVWTjNqiVZY0i63WLgTpiltIxcej66a', NULL, NULL, 1, NULL, NULL, NULL, 'uploads/custom-images/nayeem-2022-09-21-10-02-25-6264.jpg', '+88123456789', 4, 7, 10, NULL, 'catsle', 0, NULL, 1, 1, '2022-09-21 07:48:34', '2022-09-21 17:02:25'),
	(7, 'Amaya Hendrix', 'hijigov511@pahed.com', NULL, '$2y$10$slQDXnVvhpogMQB3OyqAeeIEBYNCS7pwN8rVHlYsSDv/nA3tIhEDu', 'u0FdCYSaxXIeA4RXeIae5unipHcX870CLlJfDG7FTqPHVJkfCsS1SPZ0XFew', NULL, 1, NULL, NULL, NULL, NULL, '01792166627', 2, 4, 8, NULL, 'Dhaka,bangladesh', 0, NULL, 1, 1, '2022-09-21 08:08:27', '2022-11-18 06:11:20'),
	(8, 'Harding Rosa', 'fegig12897@ploneix.com', NULL, '$2y$10$.Z7BHjmwrhswRQA1/SDRUubKwZDTtFU8GK9ZGbkxprsMCDWBycSXC', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-09-21 08:11:54', '2022-09-21 08:12:14'),
	(9, 'Nasim Horne', 'wokij22557@geekjun.com', NULL, '$2y$10$fSYHi6.oqhxsPYKZA1aASOA3YbujGYabkkoE/w/G3kKBoSRqzO2TG', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-09-21 08:17:37', '2022-09-21 08:18:01'),
	(10, 'Xaviera Barnes', 'rokayo4006@pahed.com', NULL, '$2y$10$W0ffeYoOKWHml0SiziQ7uuB0WjbSkf3hbNuuwwmNi5ZFxD/ybSD4W', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-09-21 08:21:41', '2022-09-21 08:22:03'),
	(11, 'Kelsey Conrad', 'Habbriyi', NULL, '$2y$10$6mUC3rwW9E42jqilivcw0unRzFcE/BK/6a8GbxpQXF8GIe1Gd8VVW', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '604590', 0, 1, '2022-09-21 08:24:58', '2022-11-21 11:47:07'),
	(12, 'Kelsey Conrad', 'tofor67338@geekjun.com', NULL, '$2y$10$LZJN3KNzoF6wZFyO0AvaYeyKnf7j51qGfjFWIj5nfq5czpVnCSWaa', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-09-21 08:26:08', '2022-09-21 08:27:50'),
	(14, 'Moses Haynes Short', 'cacixi5247@corylan.com', NULL, '$2y$10$SjifGqNkcVvFPhQuDFe8iebZ1KGkDpsRywLbCc3.mGA2rfp.3lO0.', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-10-27 09:33:02', '2022-10-27 09:33:14'),
	(15, 'Jason Mcneil', 'mehoke2377@sopulit.com', NULL, '$2y$10$Dpk9fNCaMpK4XI4OfdrRVO4cWPXR3DeIj1wg3CLqavI60UZP1Xdti', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, NULL, 1, 1, '2022-11-18 16:13:08', '2022-11-23 02:07:48'),
	(16, 'Test Test', 'test@gmail.con', NULL, '$2y$10$N35xuiQ2nWwntEwfeTbPHe9eFsskk4C/xx.Z8hc0hhmkbvlo95rEi', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '976621', 0, 1, '2022-11-22 07:16:45', '2022-11-22 07:16:45'),
	(17, 'suraj c', 's@g.com', NULL, '$2y$10$/ya3vIvGKDW3MDZxFfB39uvYYCJD20fX7jUg52FX6fBks2ZHkVsum', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, '522603', 0, 1, '2022-11-23 02:45:44', '2022-11-23 02:45:44');
